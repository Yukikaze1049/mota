var functions_d6ad677b_427a_4623_b50f_a445a3b0ef8a = 
{
	...
	*/
	...
	return [
		...
		[28, "黯魔吞噬之体", "黯夜殇拥有极强的身躯,需要战斗六次方能击败！"],
		[29, "外物不灭之道", "圣羽洛斯拥有顶尖的科技力量,需要战斗八次方能击败！"],
		[30, "龙啸九天决", "君无天开局额外先攻十五次并在随后的九回合内额外提升500%的攻击力,与此同时敌人的防御暂时失效,需要战斗九次方能击败！"],
		[31, "梦之心", "梦拥有极其诡异的心灵控制,无视主角的防御与魔防,需要战斗八次方能击败！"],
		[32, "万道聚天", "魔王拥有极其恐怖的实力,已经达到了返璞归真的境界,必须战斗九次方能击败！"],
		[33, "世界的追寻者", "魔王已展现出其真正的力量,必须战斗九次方能击败,没有人能够阻止我们二人相见，哪怕为此弑神！！——魔王"],
		[34, "世界的守望者", "从未出现过的人物,具体信息不详！"],
		[35, "生命圣女", "仙琳已达到抗衡神的存在,已经领悟了生命的奥义！"],
		[36, "抗衡真神", "世上本无神！而你就是那昙花一现的神！"],
		[37, "生命之使", "仙月拥有极其强大的生命能量,必须战斗十二次方能击败！"],
		[38, "剑道之巅", "即使剑祖旧伤重重，年事已高，但在剑的领悟上可谓是魔塔世界第一人！"],
		[39, "谶语之主", "谶祖拥有非常诡异特殊技能，需要战斗八次方能击败！"],
		[40, "虚妄黯道", "黯祖拥有极强的战斗欲望，需要战斗六次方能击败！"],
		[41, "世界的记录者", "从未出现过的人物,具体信息不详！"],
		[42, "光明海卷四", "从未出现过的人物，似乎是世界之外的存在，拥有连这个世界的神灵都无法匹敌的力量，不过为什么这位强者会来到这方世界呢？"],
		[43, "世界的殉教者", "曾经的初代勇者，为救济人类的殉教者！需要战斗九次方能击败！"],
		[44, "世界的终焉者", "从未出现过的人物,具体信息不详！"],
		[45, "谶语谶心", "从未出现过的人物,具体信息不详！知识是无知之海表面漂浮的诱饵。——邪神·谶"],
		[46, "世界线之力", "为了阻止生灵进入其他的世界线而诞生的存在。"],
		[47, "世界的赎罪者", "极致的善良即是极致的邪恶，仙雅体内蕴含的情感力量已经达到巅峰神灵的层次，必须战斗九次才能击败！"],
		[48, "剑心剑尘", "林无尘对剑的领悟已经踏入神灵层次，以半神巅峰之躯即可重创寻常神灵的存在！！"],
		[49, "溪之道", "云梦溪拥有极高的科技水平，可以凭借凡人之躯来对抗神灵！"]
	];
},
