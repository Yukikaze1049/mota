var plugins_bb40132b_638b_4a9f_b028_d3fe47acc8d1 = 
{
    ...
    "drawhero": function () {
	//改编自《一夜登天！》，通过复写绘制勇士函数实现，在画面绘制黑幕，掏空勇者周围作为灯光
	core.control.drawHero = function (status, offset) {
		...
		//此处为新定义的变量，分别是黑幕不透明度，效果开关，灯光范围，使用时 调节三个变量即可
	...
	control.prototype._checkBlock_snipe = function (snipe) {
		...
		snipe.forEach(function (t) {
			//修改下一行time的数值即可
			actions.push({ "type": "move", "loc": [t[0], t[1]], "steps": [t[3]], "time": 10, "keep": true, "async": true });
		});
		actions.push({ "type": "waitAsync" });
		core.insertAction(actions);
	}
},
    "CheckMoster": function () {
	// 漏怪检测，来自于《圣王魔塔》，有少量修改
