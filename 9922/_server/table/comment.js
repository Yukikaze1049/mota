		...
		"enemys": {
			...
			"_data": {
				...
				"value52": {
					...
					"_type": "textarea",
					"_range": "thiseval==~~thiseval||thiseval==null",
					"_docs": "战后攻击提升/残虐额外伤害百分比",
					"_data": "战后攻击提升/残虐额外伤害百分比"
				},
				"value53": {
					"_leaf": true,
					"_type": "textarea",
					"_range": "thiseval==~~thiseval||thiseval==null",
					"_docs": "战后防御提升/刮骨额外伤害百分比",
					"_data": "战后防御提升/刮骨额外伤害百分比"
				},
				"value54": {
					"_leaf": true,
					"_type": "textarea",
				...
				"floor": {
					...
					"_data": {
						...
						"hard1_enemy_ratio": {
							"_leaf": true,
							"_type": "textarea",
							"_range": "thiseval == null || (thiseval==~~thiseval && thiseval>=0)",
							"_docs": "简化难度下敌人攻防百分比",
							"_data": "简化难度下敌人攻防百分比"
						}
					}
